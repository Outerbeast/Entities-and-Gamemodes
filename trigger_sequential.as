...
Literally just multi_manager except each target is not triggered automatically, rather only when the entity is triggered manually.
...
This entity also has the trigger type "#3" which will use whatever caller entity use type was.
*/
void /* RegisterTriggerSequential() */MapInit()
{
...
class trigger_sequential : ScriptBaseEntity
{
    ...
    void KillTarget(string strTargetname, float flDelay)
    {
        ...
        g_EngineFuncs.ServerPrint( "" + strTargetname + " is killtargeted " + "\n" );
    }
    ...
    void Use(CBaseEntity@ pActivator, CBaseEntity@ pCaller, USE_TYPE useType, float flValue)
    {
        ...
        g_EngineFuncs.ServerPrint( "trigger_sequential: target is: " + strCurrentTarget + " and delay is: " + flDelay + " and use type is: " + utTriggerType + "\n" );
        ...
        if( self.pev.health > 0.0f )
        {
            ...
            //g_Scheduler.SetTimeout( this, "WaitFinished", self.pev.health );
