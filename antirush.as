...
class antirush : ScriptBaseEntity
{
    ...
    void CreatePercentPlayerTrigger()
    {
        ...
        //g_EngineFuncs.ServerPrint( "-- DEBUG -- Created AntiRush trigger zone with target: " + PercentPlayerTrigger.pev.target + " with required percentage " + fl_PercentRequired + " with bounds: " + "" + string(vZoneCornerMin.x) + " " + string(vZoneCornerMin.y) + " " + string(vZoneCornerMin.z) + " and " + string(vZoneCornerMax.x) + " " + string(vZoneCornerMax.y) + " " + string(vZoneCornerMax.z) + "\n" );
    }
